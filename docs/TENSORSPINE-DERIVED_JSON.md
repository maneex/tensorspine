...
the merged patches; `{"audio": 0.125}` the value of a token input that joined the audio stream
behind a stride of 2 and a stack of 4 (§5.3). A consumer multiplies by the counts it knows.
