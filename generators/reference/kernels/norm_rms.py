"""norm.rms@2.0.0 — x · rsqrt(mean(x²) + eps) · weight; `zero_centered` stores the
...
FIXTURES = [
    {"case": "basic", "seed": 62, "invocations": [{"input": 5}, {"input": 3}], "arguments": {"width": 64, "eps": 1e-6}},
    {"case": "zero-centered", "seed": 63, "invocations": [{"input": 5}], "arguments": {"width": 64, "eps": 1e-6, "zero_centered": True}},
]
