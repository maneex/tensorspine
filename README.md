...
| **[Reading the derived products](docs/DERIVED-PRODUCTS.md)** | What each of D1–D6 tells a serving application and what to do with it — a worked split of Qwen 3.5 4B across two devices | Practical, non-normative |
...
│   ├── DERIVED-PRODUCTS.md           reading D1–D6, with a worked split of Qwen 3.5 4B
