...
`ref.py run data/models/llama3-8b.json --checkpoint DIR --truncate decoder.layer=3 --ids … --dump …`,
then `ref.py compare ours theirs`. The hook map in the metadata is the only place HF names meet
