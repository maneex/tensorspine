...
The Armature documentation has deliberately separate roles:

| Document | Use it to answer | Authority |
|---|---|---|
| **README** (this document) | Why Armature exists, what it covers, and what is in the repository | Orientation |
| **[Model JSON guide](docs/ARMATURE-MODEL_JSON.md)** | How to read and author an `armature/2.0` JSON document | Practical, non-normative |
| **[Language specification](docs/SPECIFICATION.md)** | What a document means and which documents are valid | Normative |
| **[Glossary](docs/GLOSSARY.md)** | What an Armature term means and where its canonical definition lives | Navigational, non-normative |
...
| **[Catalog reference](docs/CATALOG-REFERENCE.md)** | What every contract, axis and precision role of the catalog declares — generated by `armature --document catalog` | Reference, generated |
