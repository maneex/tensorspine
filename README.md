...
│   └── models/                   13 model documents, one template (`decoder-causal-yarn/1.0.0.json`)
├── schemas/
...
`data/models/` contains fourteen documents: text decoders (`llama3-8b`, `llama4-scout`,
`shieldstral-3b`, `qwen3.5-4b-text` — the text trunk of Qwen 3.5 4B, tied embeddings, located),
MoE and multi-state models (`qwen3.5-35b-a3b`, `qwen3.5-397b`, `qwen3.8-27b`, `deepseek-v4-pro`
...
`llama3-8b`, `shieldstral-3b`, `colbert-v2`, `qwen3.5-4b-text`, `qwen3.8-27b`, `qwen3.5-35b-a3b` and
`qwen3.5-397b` also locate every one of their tensors in the Hugging Face checkpoint they wrap (`location`, Specification §3.4): a runtime loads
