...
| **[Reading the derived products](docs/DERIVED-PRODUCTS.md)** | What each derived product tells a serving application and what to do with it — a worked split of Qwen 3.5 4B across two devices | Practical, non-normative |
...
│   ├── DERIVED-PRODUCTS.md           reading the derived products, with a worked split of Qwen 3.5 4B
